...
<body class="loading">
				...
				<div class="container-fluid">
								...
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										<li class="breadcrumb-item"><a
											href="javascript: void(0);">Minton</a></li>
										<li class="breadcrumb-item"><a
											href="javascript: void(0);">Tasks</a></li>
					...
					<div class="card">
						<form id="app_form" method="post">
							...
							<input type="hidden" value="" name="risk_title"> <input
								type="hidden" value="" name="risk_writer"> <input
								type="hidden" value="" name="risk_status"> <input
								type="hidden" value="" name="risk_parent_no">
							<!--                        <input type="hidden" value="" name="risk_content"> -->
							<input type="hidden" value="" name="fnames"> <input
								type="hidden" name="proc" value="" />
							<div class="card-body">
								<div class="dropdown float-end">
									<a href="#" class="dropdown-toggle arrow-none text-muted"
										data-bs-toggle="dropdown" aria-expanded="false"> <i
										class='mdi mdi-dots-horizontal font-18'></i>
									</a>
									<div class="dropdown-menu dropdown-menu-end">
										<!-- item-->
										<a href="javascript:void(0);" class="dropdown-item"> <i
											class='mdi mdi-attachment me-1'></i>Attachment
										</a>
										<!-- item-->
										<a href="javascript:void(0);" class="dropdown-item"> <i
											class='mdi mdi-pencil-outline me-1'></i>Edit
										</a>
										<!-- item-->
										<a href="javascript:void(0);" class="dropdown-item"> <i
											class='mdi mdi-content-copy me-1'></i>Mark as Duplicate
										</a>
										<div class="dropdown-divider"></div>
										<!-- item-->
										<a href="javascript:void(0);"
											class="dropdown-item text-danger"> <i
											class='mdi mdi-delete-outline me-1'></i>Delete
										</a>
									</div>
								</div>
											...
											<div class="d-flex align-items-start mt-3">
												...
												<div class="flex-1 overflow-hidden">
													...
													<h5 class="mt-0 text-truncate" id="status2">
														${riskboard.risk_status}</h5>
												</div>
												<div class="flex-1 overflow-hidden">
													<p class="mb-1">상위 글번호</p>
													<h5 class="mt-0 text-truncate">
														${riskboard.risk_parent_no}</h5>
												</div>
											</div>
										</div>
									</div>
												...
												<div class="p-2">
													<div class="row align-items-center">
														<div class="col-auto">
															<div class="avatar-sm">
																<span
																	class="avatar-title bg-soft-primary text-primary rounded">File</span>
															</div>
														</div>
														<div class="col ps-0">
															<input name="ffname" class="text-muted fw-semibold"
																value="${finf.filename}" />
															<p class="mb-0"></p>
														</div>
														<div class="col-auto">
							...
							<div class="p-2">
								<ul class="pager wizard mb-0 list-inline text-end mt-3">
									<li class="previous list-inline-item">
										<!-- 작성화면 전으로 돌아가는 버튼 --> <c:if
											test="${mem.auth == 'pm' || mem.auth =='wk'}">
											<c:if test="${riskboard.risk_status == '승인'}">
												<a href="${path}/risk.do?method=riskBoard&no=${param.no}"
													type="button" class="btn btn-secondary"><i
													class="mdi mdi-arrow-left"></i>목록으로</a>
											</c:if>
											<c:if test="${riskboard.risk_status == '미승인'}">
												<a href="${path}/risk.do?method=riskRequest&no=${param.no}"
													type="button" class="btn btn-secondary"><i
													class="mdi mdi-arrow-left"></i>목록으로</a>
											</c:if>
										</c:if> <c:if test="${mem.auth == 'ceo' || mem.auth =='hp'}">
											<a href="${path }/risk.do?method=riskBoardAll" type="button"
												class="btn btn-secondary"><i class="mdi mdi-arrow-left"></i>목록으로</a>
										</c:if> <c:if test="${mem.auth == 'pm'}">
											<c:if test="${riskboard.risk_status == '미승인'}">
												<button href="" id="adBtn" type="button"
													class="btn btn-primary">승인하기</button>
											</c:if>
											<c:if test="${riskboard.risk_status == '승인'}">
												<button href="" id="rpBtn" type="button"
													class="btn btn-primary">답글달기</button>
											</c:if>
										</c:if> <c:if test="${mem.name == riskboard.risk_writer}">
											<c:if test="${riskboard.risk_status == '미승인'}">
												<button href="" id="uptBtn" type="button"
													class="btn btn-warning">수정하기</button>
											</c:if>
										</c:if> <c:if
											test="${mem.name == riskboard.risk_writer || mem.auth == 'pm'}">
		...
		<div data-simplebar class="h-100">
			...
			<ul class="nav nav-tabs nav-bordered nav-justified" role="tablist">
				<li class="nav-item"><a class="nav-link py-2"
					data-bs-toggle="tab" href="#chat-tab" role="tab"> <i
						class="mdi mdi-message-text-outline d-block font-22 my-1"></i>
				</a></li>
				<li class="nav-item"><a class="nav-link py-2"
			...
			<div class="tab-content pt-0">
				<div class="tab-pane" id="chat-tab" role="tabpanel">
						...
						<a href="javascript: void(0);"
							...
							<div class="d-flex align-items-start">
								<div class="position-relative me-2">
									<span class="user-status"></span> <img
										src="${path}/Admin/dist/assets/images/users/avatar-10.jpg"
							...
							<div class="d-flex align-items-start">
								<div class="position-relative me-2">
									<span class="user-status"></span> <img
										src="${path}/Admin/dist/assets/images/users/avatar-1.jpg"
										class="rounded-circle avatar-sm" alt="user-pic">
								</div>
								<div class="flex-1 overflow-hidden">
							...
							<div class="d-flex align-items-start">
								<div class="position-relative me-2">
									<span class="user-status busy"></span> <img
										src="${path}/Admin/dist/assets/images/users/avatar-9.jpg"
										class="rounded-circle avatar-sm" alt="user-pic">
								</div>
								<div class="flex-1 overflow-hidden">
					...
					<div class="p-2 pb-4">
						<a href="javascript: void(0);"
							...
							<div class="d-flex align-items-start">
								<div class="position-relative me-2">
									<span class="user-status online"></span> <img
										src="${path}/Admin/dist/assets/images/users/avatar-2.jpg"
										class="rounded-circle avatar-sm" alt="user-pic">
								</div>
								<div class="flex-1 overflow-hidden">
							...
							<div class="d-flex align-items-start">
								<div class="position-relative me-2">
									<span class="user-status away"></span> <img
										src="${path}/Admin/dist/assets/images/users/avatar-4.jpg"
										class="rounded-circle avatar-sm" alt="user-pic">
								</div>
								<div class="flex-1 overflow-hidden">
							...
							<div class="d-flex align-items-start">
								<div class="position-relative me-2">
									<span class="user-status online"></span> <img
										src="${path}/Admin/dist/assets/images/users/avatar-5.jpg"
										class="rounded-circle avatar-sm" alt="user-pic">
								</div>
								<div class="flex-1 overflow-hidden">
							...
							<div class="d-flex align-items-start">
								<div class="position-relative me-2">
									<span class="user-status online"></span> <img
										src="${path}/Admin/dist/assets/images/users/avatar-6.jpg"
										class="rounded-circle avatar-sm" alt="user-pic">
								</div>
								<div class="flex-1 overflow-hidden">
							...
							<div class="d-flex align-items-start">
								<div class="position-relative me-2">
									<span class="user-status busy"></span> <img
										src="${path}/Admin/dist/assets/images/users/avatar-7.jpg"
										class="rounded-circle avatar-sm" alt="user-pic">
								</div>
								<div class="flex-1 overflow-hidden">
							...
							<div class="d-flex align-items-start">
								<div class="position-relative me-2">
									<span class="user-status away"></span> <img
										src="${path}/Admin/dist/assets/images/users/avatar-8.jpg"
										class="rounded-circle avatar-sm" alt="user-pic">
								</div>
								<div class="flex-1 overflow-hidden">
				...
				<div class="tab-pane" id="tasks-tab" role="tabpanel">
					...
					<h6 class="fw-medium px-3 mb-0 mt-4 text-uppercase">Upcoming
						Tasks</h6>
				...
				<div class="tab-pane active" id="settings-tab" role="tabpanel">
					...
					<div class="p-3">
						...
						<div class="form-check form-switch mb-1">
							<input class="form-check-input" type="checkbox"
								name="topbar-color" value="light" id="lighttopbar-check">
							<label class="form-check-label" for="lighttopbar-check">Light</label>
						</div>

						<!-- Left Sidebar-->
						<h6 class="fw-medium font-14 mt-4 mb-2 pb-1">Left Sidebar
							Color</h6>
						<div class="form-check form-switch mb-1">
							<input class="form-check-input" type="checkbox"
						...
						<div class="form-check form-switch mb-1">
							<input class="form-check-input" type="checkbox"
								...
								class="form-check-label" for="dark-check">Dark</label>
						</div>

						<div class="form-check form-switch mb-1">
							<input class="form-check-input" type="checkbox"
								name="leftsidebar-color" value="brand" id="brand-check">
						...
						<div class="form-check form-switch mb-1">
							<input class="form-check-input" type="checkbox"
								name="leftsidebar-size" value="compact" id="compact-check">
						...
						<!-- User info -->
						<h6 class="fw-medium font-14 mt-4 mb-2 pb-1">Sidebar User
							Info</h6>
						<div class="form-check form-switch mb-1">
							<input class="form-check-input" type="checkbox"
	...
	<!-- Plugins js -->
	<script
		src="${path}/Admin/dist/assets/libs/dropzone/min/dropzone.min.js"></script>

	<!-- Init js-->
	<script
		src="${path}/Admin/dist/assets/js/pages/form-fileuploads.init.js"></script>
